...
const Map<String, Map<String, List<String>>> mess_2 = {
  ...
  "Tuesday": {
    ...
    "Snacks": ["Onion Aloo", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Kuska",
      "Sev Tamatar",
  ...
  "Thursday": {
    ...
    "Snacks": ["Sweet Corm Salad/Channa Masala", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Dum Aloo",
      "Egg Masala",
  ...
  "Saturday": {
    ...
    "Lunch": [
      ...
      "Roti",
      "Channa Dal",
      "Khichdi/Coconut Rice"
          "Brinjal fry",
      "Sambhar",
      "Rasam",
      "Butter Milk",
    ],
    "Snacks": ["Patties/Cream Roll/Bhel Puri/Spring Roll", "Tea, Coffee, Milk"],
    "Dinner": [
      "Chapati",
      "Fried Rice/Noodles",
      "Aloo Badi",
...
const Map<String, Map<String, List<String>>> mess_3 = {
  ...
  "Tuesday": {
    ...
    "Dinner": [
      ...
      "Rasam",
      "Pickle",
      "Fruit Custard/ Vermicelli Kheer",
    ],
  },
  "Wednesday": {
    "Breakfast": [
      "Idli",
      "Medhu Vada/ Masala Vada",
    ...
    "Snacks": ["Bhel Puri/ Chole Chat", "Tea, Coffee, Milk"],
    "Dinner": [
      "Chapati",
      "Plain Dal",
      "White Rice",
  ...
  "Friday": {
    ...
    "Snacks": ["Dhokla/ Masala Peanut", "Green Chutney", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Dal Tadka",
      "White Rice",
  ...
  "Saturday": {
    ...
    "Snacks": ["Spring Roll","Tomato Sauce", "Tea, Coffee, Milk"],
    "Dinner": [
      "Jeera Chapati",
      "Fried Rice/Noodles",
      "Masoor Dal",
