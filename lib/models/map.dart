...
const Map<String, Map<String, List<String>>> mess_1 = {
  ...
  "Friday": {
    ...
    "Snacks": ["Patties", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Rice",
      "Dal Tadka",
...
const Map<String, Map<String, List<String>>> mess_2 = {
  ...
  "Wednesday": {
    ...
    "Snacks": ["Pani Puri/Medu Vada", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Rice",
      "Plain Dal",
  ...
  "Thursday": {
    ...
    "Snacks": ["Sweet Corm Salad/Dahi Vada", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Aloo Masala",
      "Egg Masala",
  ...
  "Friday": {
    ...
    "Snacks": ["Patties/Cream Roll", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Rice",
      "Dal Tadka",
...
const Map<String, Map<String, List<String>>> mess_4 = {
  "Monday": {
    "Breakfast": [
      "Idly",
      "Midhu Vada",
    ...
    "Snacks": ["Kachori/Aloo Chana Chat", "Sauce/Chutney", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Mix Veg",
      "Egg Gravy",
  ...
  "Tuesday": {
    ...
    "Snacks": ["Pani Puri", "Sauce/Chutney", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Kuska",
      "Sev Tomato",
  ...
  "Wednesday": {
    ...
    "Snacks": ["Samosa/Noodles", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Rice",
      "Plain Dal",
  ...
  "Friday": {
    ...
    "Snacks": ["Pasta/Dahi Wada", "Green Chutney", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Rice",
      "Dal Tadka",
  ...
  "Saturday": {
    ...
    "Snacks": ["Cutlet/Dhokla", "Sauce/Chutney", "Tea, Coffee, Milk"],
    "Dinner": [
      "Roti",
      "Jeera Rice",
      "Dal Fry",
